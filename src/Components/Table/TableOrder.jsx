...
const Content = ({ data, index, setShow, setContent }) => {
  ...
  const editMutation = useMutation(editStatusOrder, {
    onSuccess: () => {
      cache.invalidateQueries("my-order");
    },
  });
      ...
      <td>
        {data.status === "Waiting Approve" ? (
          <div className="flex justify-center">
            <div className="w-6 h-6 bg-yellow-400 px-1 rounded-full flex justify-center">
              <i
          ...
          <div className="flex justify-center">
            <div className="w-6 h-6 bg-blue-200 px-1 rounded-full flex justify-center">
              <i
                className="fa fa-hourglass fa-xs text-white my-auto"
                aria-hidden="true"
              ></i>
